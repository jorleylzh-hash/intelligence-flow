...
def show_splash_screen():
    """
    Exibe uma animação 'Tree of Life / Neural Network'.
    """
    if 'splash_shown' in st.session_state and st.session_state['splash_shown']:
        return

    # URL: Rede Neural/Árvore Digital Azul Neon
    ...
    with placeholder.container():
        ...
        .splash-bg-video {{
            ...
            opacity: 0.5; /* Opacidade ajustada para dar destaque ao texto */
            object-fit: cover;
        }}
        ...
        <div class="splash-fullscreen">
            ...
            <div class="loading-text">Intelligence Flow<br><span style="font-size:0.8em; color:white;">Connecting Markets...</span></div>
        </div>
